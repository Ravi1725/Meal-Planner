...
const apiKey = "c1440239d06d41468c7a99cc5d7359af";
...
function calculatCalories(physicalActivity,BMR){
    var calories;
...
const getCalorie = () => {
    ...
    if (height === "" || height <= 0 || weight === "" || weight <= 0 || age === "" || age <= 0) {
        ...
        alert(
            "Height and Weight should be in number"
        );
        return;
    }
    ...
    const calories=calculatCalories(physicalActivity,BMR);
